...
############################# Single select listbox ###################################
 ##  Selecting the cars from demo.html
...
#Selecting multiple cars from demo.html
...
#
# driver.find_elements("xpath",'//button[@type="submit"]')
# time.sleep(2)
...
##Selecting the date from ----https://www.facebook.com/r.php?entry_point=login
