...
#python -m pytest test_filename.py -vs
...
#
#     def test_fname(self):
#         driver.find_element('id', 'FirstName').send_keys('jiya')
#
#     def test_lname(self):
#         driver.find_element('id', 'LastName').send_keys('abbot')
#
#     def test_reg_email(self):
#         driver.find_element('id', 'Email').send_keys('jiya@gmail.com')
#
#     def test_reg_pwd(self):
#         driver.find_element('id', 'Password').send_keys('jiyu@12345')
#
#     def test_confirm_pwd(self):
#         driver.find_element('id', 'ConfirmPassword').send_keys('jiyu@12345')
#
#
# class TestLogin:
#
