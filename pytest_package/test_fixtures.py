...
# commond
#
# # python -m pytest filename.py -vs -html="demo_report.html"
# # python -m pytest test_fixtures.py -vs -html="C:\Users\Jiya Abbot\PycharmProjects\selenium_traning\files\demowebshop.html"
#
 ## files -- demowebshop.html
# ## demo_report --- open In --- browser
#
# * html we use
#
# '''
